...
Xtrim uses a modern JavaScript-heavy frontend. Plan pricing cards render dynamically
...
Target URLs:
    Main:      https://www.xtrim.com.ec/internet/
"""
...
class XtrimScraper(BaseISPScraper):
    """Scraper for Xtrim internet plans.

    Handles Xtrim Ecuador's JS-based website. Plan cards
    ...
    def get_plan_urls(self) -> list[str]:
        """Return Xtrim Ecuador URLs containing plan information.
        ...
        """
        return [
            "https://www.xtrim.com.ec/internet/",
            "https://www.xtrim.com.ec/",
        ]

    def requires_playwright(self) -> bool:
        """Xtrim requires Playwright — SPA.

        Returns:
            True always — Xtrim's frontend is fully JS-rendered.
        """
        return True

    async def scrape(self) -> ScrapedPage:
        """Execute Xtrim scraping with Playwright + screenshot strategy.
