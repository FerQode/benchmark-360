...
Alfanet uses a JavaScript-heavy frontend. Plan pricing cards render dynamically
...
Target URLs:
    Main:      https://www.alfanet.ec/planes/
"""
...
class AlfanetScraper(BaseISPScraper):
    """Scraper for Alfanet internet plans.

    Handles Alfanet Ecuador's JS-based website. Plan cards
    ...
    def get_plan_urls(self) -> list[str]:
        """Return Alfanet Ecuador URLs containing plan information.
    ...
    def requires_playwright(self) -> bool:
        """Alfanet requires Playwright — SPA.

        Returns:
            True always — Alfanet's frontend is fully JS-rendered.
        """
        return True

    async def scrape(self) -> ScrapedPage:
        """Execute Alfanet scraping with Playwright + screenshot strategy.
