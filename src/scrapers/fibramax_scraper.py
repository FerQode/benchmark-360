...
Fibramax uses a JavaScript-heavy frontend. Plan pricing cards render dynamically
...
Target URLs:
    Main:      https://www.fibramax.ec/planes/
"""
...
class FibramaxScraper(BaseISPScraper):
    ...
    Handles Fibramax Ecuador's JS-based website. Plan cards
    ...
    def __init__(
        ...
        super().__init__(
            isp_key="fibramax",
            base_url="https://www.fibramax.ec",
    ...
    def get_plan_urls(self) -> list[str]:
        """Return Fibramax Ecuador URLs containing plan information.
    ...
    def requires_playwright(self) -> bool:
        """Fibramax requires Playwright — SPA.

        Returns:
            True always — Fibramax's frontend is fully JS-rendered.
        """
        return True

    async def scrape(self) -> ScrapedPage:
        """Execute Fibramax scraping with Playwright + screenshot strategy.
