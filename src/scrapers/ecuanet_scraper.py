...
Ecuanet uses a JavaScript-heavy frontend. Plan pricing cards render dynamically
...
Target URLs:
    Main:      https://www.ecuanet.ec/planes/
"""
...
class EcuanetScraper(BaseISPScraper):
    """Scraper for Ecuanet internet plans.

    Handles Ecuanet Ecuador's JS-based website. Plan cards
    ...
    def get_plan_urls(self) -> list[str]:
        """Return Ecuanet Ecuador URLs containing plan information.
        ...
        """
        return [
            "https://www.ecuanet.ec/planes/",
            "https://www.ecuanet.ec/",
        ]

    def requires_playwright(self) -> bool:
        """Ecuanet requires Playwright — SPA.

        Returns:
            True always — Ecuanet's frontend is fully JS-rendered.
        """
        return True

    async def scrape(self) -> ScrapedPage:
        """Execute Ecuanet scraping with Playwright + screenshot strategy.
