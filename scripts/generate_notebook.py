...
Generates benchmark_industria_notebook.ipynb programmatically.
Run: uv run python scripts/generate_notebook.py
"""
import json
...
print(f"Notebook generado: {out} ({out.stat().st_size / 1024:.1f} KB, {len(CELLS)} celdas)")
